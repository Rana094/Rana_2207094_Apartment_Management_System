...
@section('title', 'Update Work Order #T-'.($workOrder?->id ?? '2033').' - Nestora')

@section('content')
<div class="db-header">
    <a href="{{ $workOrder ? route('maintenance.show', $workOrder) : route('maintenance.dashboard') }}" style="display: flex; align-items: center; gap: 0.25rem; font-size: 0.85rem; font-weight: 600; color: var(--text-secondary); margin-bottom: 0.5rem;">
...
@if (! $workOrder)
    <div style="max-width: 680px; margin: 0 auto;">
        <div class="card">
            ...
            <div class="alert alert-danger">This demo work order is not connected to the database. Open an assigned work order from your dashboard.</div>
        </div>
    </div>
@else
    <div style="max-width: 680px; margin: 0 auto;">
