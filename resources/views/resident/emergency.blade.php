...
@section('title', 'Emergency Request Panel — Nestora')
...
<div class="db-header">
    <h1 class="db-title" style="color: var(--color-emergency);">Emergency Alarm Dispatch</h1>
    <p class="db-subtitle">Trigger an instant high-priority panic alert to the Main Security Gate Office and Building Manager.</p>
</div>
...
<div class="panic-container">
    <div class="panic-card">
        ...
        <h3 style="font-size: 1.4rem; color: var(--text-primary); margin-bottom: 0.5rem;">Instant Panic Trigger</h3>
        <p style="font-size: 0.875rem; color: var(--text-secondary); max-width: 440px; margin: 0 auto 1.5rem auto;">
            Select your emergency type below. Pressing the button will sound a warning alarm at the guard room dashboard and send your flat number (Flat 3B) for immediate dispatch.
        </p>
        ...
        <form action="#" method="POST" id="panic-form">
            ...
            <div class="form-group" style="max-width: 320px; margin: 0 auto 1.5rem auto;">
                <label for="emerg-type" class="form-label">Emergency Category</label>
                <select id="emerg-type" name="type" class="form-control form-select" style="text-align: center;" required>
                    <option value="medical" selected>Medical Emergency / Ambulance</option>
                    <option value="fire">Fire / Smoke Alarm</option>
                    <option value="leak">Severe Gas / Water Pipe Leak</option>
            ...
            <button type="button" class="panic-btn-giant" onclick="triggerPanicAlert()">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" style="width: 2.5rem; height: 2.5rem;">
        ...
        <div id="panic-alert-state" style="display: none; padding: 1.5rem 0;">
            ...
            <p style="font-weight: 700; font-size: 1.1rem; color: var(--text-primary); margin-bottom: 0.5rem;">Security Staff Dispatched</p>
            <p style="font-size: 0.875rem; color: var(--text-secondary); line-height: 1.6; max-width: 400px; margin: 0 auto 1.5rem auto;">
                A security guard from the main gate lobby is heading to <strong>Building A, Flat 3B</strong>. Please keep your doors unlocked if safe to do so.
            </p>
            <button type="button" class="btn btn-outline btn-sm" onclick="cancelPanicAlert()" style="border-color: var(--color-emergency); color: var(--color-emergency);">
                Cancel Alarm / False Trigger
            </button>
        </div>
        
        <!-- Emergency Numbers list -->
        <div style="border-top: 1px solid var(--border-color); padding-top: 2rem; margin-top: 2rem; text-align: left; font-size: 0.85rem;">
            <h4 style="font-weight: 700; color: var(--text-primary); margin-bottom: 1rem;">National Emergency Helplines:</h4>
            <div class="grid grid-2" style="gap: 1rem;">
                <div style="background-color: var(--bg-main); padding: 0.75rem 1rem; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-weight: 700; color: var(--text-primary);">National Service:</span>
                    <strong style="color: var(--color-emergency); font-size: 1rem;">999</strong>
                </div>
                <div style="background-color: var(--bg-main); padding: 0.75rem 1rem; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-weight: 700; color: var(--text-primary);">Society Guard Room:</span>
                    <strong style="color: var(--primary-color); font-size: 1rem;">+880 1711 098765</strong>
                </div>
            </div>
        </div>
    </div>
