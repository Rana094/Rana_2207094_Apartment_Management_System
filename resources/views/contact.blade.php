    ...
    <div class="container">
        ...
        <div class="contact-container">
            ...
            <div class="form-panel">
                ...
                {{-- Stores a ContactMessage through the /contact POST route and notifies managers. --}}
        ...
        <div class="map-panel">
            {{-- Image is generated by LocationController@apartmentMap using Geoapify on the backend. --}}
